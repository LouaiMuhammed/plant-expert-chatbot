...
class OpeeAIProvider(LLMInterface):
    ...
    def __init__(self, api_key: str, api_url: str=None,
        ...
        def embed_text(self, text: str, document: str = None):
            ...
            if not self.embedding_model_id:
                self.logger.error("Embedding model for OpenAIwas not set")
                return None
            ...
            if not response or not len(response.data) == 0 or not response.data[0].embedding:
